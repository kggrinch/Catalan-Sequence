...
If needed for larger calculations, the program could be modified to return long, but it might be better to calculate the Catalan using a different approach for larger calculation.
*/ 
int catalan(int n)
{
